...
`ggplot2` is a package of plotting that is very popular and powerful. `qplot` is a short hand for "quick plot".  Let's try this out on the childhood mortality data used above. However, let's do some manipulation first, by using `gather` on the data to convert to long. 
