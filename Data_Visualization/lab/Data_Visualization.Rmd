...
```{r plotEx, comment="",prompt=TRUE, fig.width=5.5,fig.height=5.5, fig.align='center',cache=TRUE}
...
```{r plot1, comment="",prompt=TRUE, fig.width=6,fig.height=6, fig.align='center',cache=TRUE}
...
```{r plotEx2, comment="",prompt=TRUE, fig.width=6,fig.height=6, fig.align='center',cache=TRUE}
plot(as.numeric(death["Sweden",])~year,
...
```{r plotEx3, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
plot(as.numeric(death["Sweden",])~year,
      ylab="# of deaths per family", main = "Sweden",
...
```{r plotEx4, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r plotEx5, comment="",prompt=TRUE, fig.width=10,fig.height=5,fig.align='center', cache=TRUE}
par(mfrow=c(1,2))
scatter.smooth(as.numeric(death["Sweden",])~year,span=0.2,
      ylab="# of deaths per family", main = "Sweden",lwd=3,
     xlim = c(1760,2012), pch = 19, cex=0.9,col="grey")
...
```{r plotEx6, comment="",prompt=TRUE, fig.width=10,fig.height=5,fig.align='center', cache=TRUE}
par(mfrow=c(1,2))
...
```{r barplot2, comment="",prompt=TRUE, fig.width=5,fig.height=5,fig.align='center', cache=TRUE}
## Stacked Bar Charts
...
```{r barplot2a, comment="",prompt=TRUE, fig.width=5,fig.height=5,fig.align='center', cache=TRUE}
...
```{r barplot3, comment="",prompt=TRUE, fig.width=5,fig.height=5,fig.align='center', cache=TRUE}
...
```{r boxplots, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r geoboxplot, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
library(ggplot2)
...
```{r geoboxpoint, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r hist, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r ghist, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
qplot(x = weight, 
      fill = factor(Diet),
      data = ChickWeight, 
      geom = c("histogram"))
...
```{r ghist_alpha, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r gdens, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r gdens_alpha, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r gdens_alpha_gg, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r gdens_line_alpha, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=TRUE}
...
```{r spaghetti, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r fac_spag, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r fac_spag_noleg, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
qplot(x=Time, y=weight, colour = Chick, facets = ~ Diet, 
...
```{r pal3, comment="",prompt=TRUE, fig.width=6.5,fig.height=6.5,fig.align='center', cache=FALSE}
palette("default")
...
```{r pal4, comment="",prompt=TRUE, fig.width=6.5,fig.height=6.5,fig.align='center', cache=FALSE}
...
```{r pal5, comment="",prompt=TRUE, fig.width=6.5,fig.height=6.5,fig.align='center', cache=FALSE}
library(RColorBrewer)
palette(brewer.pal(5,"Dark2"))
...
```{r leg1, comment="",prompt=TRUE, fig.width=6.5,fig.height=6.5,fig.align='center', cache=FALSE}
palette(brewer.pal(5,"Dark2"))
plot(weight ~ jitter(Time,amount=0.2),data=ChickWeight,
                pch = 19,  col = Diet,xlab="Time")
...
```{r circ, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r circ2, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r lattice1, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
library(lattice)
...
```{r lattice2, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r levelplot1, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r levelplot2, comment="",prompt=TRUE, fig.width=6,fig.height=6,fig.align='center', cache=FALSE}
...
```{r levelplot3, comment="",prompt=TRUE, fig.width=10,fig.height=6,fig.align='center', cache=TRUE}
library(RColorBrewer)
